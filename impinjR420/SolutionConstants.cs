...
namespace impinjR420
{
    ...
    public class SensorParams
    {
        ...
        public static string[] epcs = new string[] {SolutionConstants.refepc, "E200 5147 960D 0170 1490 7CB7", "E200 4000 770E 0069 1660 6C24", "E200 497E 93D1 D5F1 34FF A757" };//cabinet, coffeemaker,  fridge
        public static string[] names = new string[] {"Ref", "Cabinet", "Coffee Maker", "Fridge" };//cabinet, coffeemaker,  fridge
